...
public class CartController {
    ...
    @PostMapping("/merge")
    public ResponseEntity<List<Item>> mergeCart(
            @RequestHeader(value = "cartId") String guestCartId,
            @RequestHeader(value = "X-Auth-UserId") String xAuthUserId) {
        
        String userCartId = "USER_" + xAuthUserId;
        cartService.mergeCart(guestCartId, userCartId);
        
        List<Item> items = cartService.getAllItemsFromCart(userCartId);
        return new ResponseEntity<>(items, headerGenerator.getHeadersForSuccessGetMethod(), HttpStatus.OK);
    }
}
