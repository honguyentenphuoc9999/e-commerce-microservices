          ...
          {user ? (
            <div className="flex items-center gap-2">
              <Link href={user.role === "ROLE_ADMIN" ? "/admin" : "/profile"} className="flex items-center gap-3 text-[#bec6e0] hover:bg-[#e9c349]/10 p-1.5 pr-4 rounded-full transition-all bg-[#222a3d]/40 border border-white/5 hover:border-[#e9c349]/30 group">
                <div className="w-8 h-8 rounded-full overflow-hidden border border-[#e9c349]/30 group-hover:scale-110 transition-transform">
                  <img 
                ...
                <span className="hidden sm:inline text-[10px] font-black uppercase tracking-[0.15em] text-slate-300 group-hover:text-white transition-colors">
