...
import { ArrowLeft, Save, Image as ImageIcon, Layout, Type, AlignLeft, Upload, X } from "lucide-react";
            ...
            <div className="max-w-4xl mx-auto">
                <div className="flex items-center justify-between mb-12">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-3xl font-black tracking-tight">Tạo Bài Viết Mới</h1>
                    </div>
                    <button 
                    ...
                    >
                        <Save size={20} /> {saving ? "Đang lưu..." : "ĐĂNG BÀI VIẾT"}
                    </button>
                </div>
                ...
                <div className="space-y-8 pb-20">
                    ...
                    <div className="space-y-3">
                        <div className="flex justify-between items-end">
                            ...
                            <span className={`text-[10px] font-black uppercase tracking-tighter ${formData.summary.length > 1000 ? 'text-red-500' : 'text-slate-500'}`}>
                                {formData.summary.length}/1000
                            </span>
                        </div>
                        <textarea 
                            placeholder="Nhập đoạn tóm tắt ngắn gọn hoặc trích dẫn nội dung chính..."
