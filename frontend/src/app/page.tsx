      ...
      <section className="pt-40 pb-20 px-6 overflow-hidden">
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative h-[600px] w-full lg:w-[130%] lg:-ml-[15%] flex items-center justify-center group overflow-hidden"
          >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-2">
                      ...
                      <Link href={`/collections?category=${cat.categoryName}`} className="inline-flex items-center pt-2 text-[9px] font-black uppercase tracking-widest hover:translate-x-1 transition-transform group text-[#e9c349]">
