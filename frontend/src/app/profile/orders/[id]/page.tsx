      ...
      <header className="space-y-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex items-center gap-4">
            <h1 className="text-4xl font-headline font-extrabold text-white tracking-tighter italic">Chi tiết đơn #ATL-{order.id}</h1>
              ...
              {order.items.map((item: any, idx: number) => (
                <div key={idx} className="p-10 flex items-center gap-8 group">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <p className="text-slate-500 text-[10px] font-black uppercase tracking-widest">SKU: ATL-ITEM-{item.product?.id}</p>
          ...
          <div className="bg-[#131b2e]/40 rounded-[2.5rem] border border-white/5 shadow-2xl p-10 space-y-10 backdrop-blur-xl">
            ...
            <div className="relative space-y-10 before:absolute before:inset-0 before:ml-[11px] before:w-0.5 before:bg-white/5">
              <div className="relative pl-12">
                ...
                <p className="text-xs text-slate-500 mt-1 uppercase tracking-widest font-bold">Atelier Express Delivery</p>
              </div>
              <div className="relative pl-12">
                ...
                <p className={`text-sm font-black uppercase tracking-widest ${['SHIPPING', 'IN_TRANSIT', 'DELIVERED', 'COMPLETED'].includes(order.orderStatus) ? 'text-white' : 'text-slate-600'}`}>Đang vận chuyển</p>
                <p className="text-xs text-slate-500 mt-1 uppercase tracking-widest font-bold">In Transit</p>
              </div>
              <div className="relative pl-12">
                <span className="absolute left-0 top-1 w-6 h-6 rounded-full bg-amber-400 flex items-center justify-center text-[#0b1326] shadow-lg shadow-amber-400/20">
                  <Package size={14} />
                </span>
                <p className="text-sm font-black uppercase tracking-widest text-white">Đã tiếp nhận & Đang xử lý</p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-slate-300 italic">Atelier Express (Ưu tiên)</p>
                </div>
              </div>
            </div>
          </div>
