    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const articlesArray = Array.isArray(relatedData) ? relatedData : (relatedData?.content || []);
                setRelatedArticles(articlesArray.filter((a: Article) => a.id !== Number(id)).slice(0, 4));
    ...
    const renderSingleComment = (comment: Comment) => (
        ...
        >
            <div className="shrink-0 pt-2">
                <div className="w-12 h-12 rounded-2xl overflow-hidden border border-white/10 group-hover:border-blue-500/30 transition-all shadow-xl">
                    <img 
