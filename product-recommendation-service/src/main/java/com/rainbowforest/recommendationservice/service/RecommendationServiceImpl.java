...
public class RecommendationServiceImpl implements RecommendationService {
    ...
    @Override
    public Page<Recommendation> getAllRecommendationsPaginated(Pageable pageable) {
        return recommendationRepository.findAll(pageable);
    }

    @Override
    public Page<Recommendation> getRecommendationsByRatingPaginated(int rating, Pageable pageable) {
        return recommendationRepository.findByRating(rating, pageable);
    }

    @Override
    public Page<Recommendation> getRecommendationsByRatingRangePaginated(int min, int max, Pageable pageable) {
        return recommendationRepository.findByRatingBetween(min, max, pageable);
    }
}
